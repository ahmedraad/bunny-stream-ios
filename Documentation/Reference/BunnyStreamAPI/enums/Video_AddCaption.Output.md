...
```swift
public var ok: Operations.Video_AddCaption.Output.Ok
```
...
```swift
public var badRequest: Operations.Video_AddCaption.Output.BadRequest
```
...
```swift
public var unauthorized: Operations.Video_AddCaption.Output.Unauthorized
```
...
```swift
public var notFound: Operations.Video_AddCaption.Output.NotFound
```
...
```swift
public var internalServerError: Operations.Video_AddCaption.Output.InternalServerError
```

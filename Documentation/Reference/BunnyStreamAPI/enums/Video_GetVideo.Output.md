...
```swift
case ok(Operations.Video_GetVideo.Output.Ok)
```
...
```swift
case unauthorized(Operations.Video_GetVideo.Output.Unauthorized)
```
...
```swift
case notFound(Operations.Video_GetVideo.Output.NotFound)
```
...
```swift
case internalServerError(Operations.Video_GetVideo.Output.InternalServerError)
```
...
```swift
public var ok: Operations.Video_GetVideo.Output.Ok
```
...
```swift
public var internalServerError: Operations.Video_GetVideo.Output.InternalServerError
```
